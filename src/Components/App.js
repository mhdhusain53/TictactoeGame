...
const App = ()=>{
    ...
    const setGame=(event)=>{
        ...
        if(sizeSelected===0){
            ...
            if((tt[tableno]>sizeSelected && tt[tableno]<7)||(tt[tableno]>6 && (tt[tableno]-6)>sizeSelected ) || tt[tableno]===0){
        ...
        }else if (no%2===1&&sizeSelected<13){
    ...
    const checkGame=()=>{
        ...
        if( (t[0]<7&&t[1]<7&&t[2]<7&&t[0]!==0&&t[1]!==0&t[2]!==0) || 
            ...
            (t[0]<7&&t[4]<7&&t[7]<7&&t[0]!==0&&t[4]!==0&t[7]!==0) ||
            ...
            (t[0]>6&&t[4]>6&&t[7]>6&&t[0]!==0&&t[4]!==0&t[7]!==0) ||
